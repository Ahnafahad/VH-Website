 ...
 *
 * Stores a site-wide PushSubscription for the authenticated user. Called by
 * usePushNotifications.subscribe() (site-wide variant) after the browser grants
 * push permission.
 *
...
export async function POST(req: NextRequest) {
  return safeApiHandler(async () => {
    ...
    await db
      .update(users)
      .set({
        pushSubscription: JSON.stringify(parsed.data.subscription),
        updatedAt:        new Date(),
      })
