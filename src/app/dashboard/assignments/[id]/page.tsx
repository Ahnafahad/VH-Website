...
export default async function AssignmentDetailPage({ params }: PageProps) {
  ...
  // submission.fileUrl is a raw upload (no materials-library row), so it still
  // resolves to a presigned R2 URL and opens directly, same as before.
  // The question attachment and solution PDF, by contrast, ARE materials-library
  // rows — route them through /dashboard/materials/[id] (the same in-app PDF
  // viewer lecture materials use) instead of a raw storage link.
