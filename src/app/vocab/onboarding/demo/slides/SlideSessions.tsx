...
export default function SlideSessions({ onNext, stepLabel }: Props) {
  ...
  return (
    <DemoSlideLayout
      ...
      label="Daily Path"
      title="Your Sessions"
      description="Sessions guide your daily study. Tap any session to jump straight in."
      ctaLabel="Next"
      ...
      <div className="flex w-full flex-col gap-2">
        {SESSIONS.map((s) => (
          <motion.button
            ...
            className="relative flex items-center gap-3 rounded-xl px-3 py-3 text-left"
            style={{
        ...
        >
          {unlocked ? 'Session selected!' : 'Tap a session to continue'}
        </p>
      </div>
    </DemoSlideLayout>
  );
