// Generic LexiCore route-loading skeleton (used by loading.tsx files so App
// Router always paints a fallback instead of blocking navigation on the RSC
// response). Hardcoded colors so it's visible even before CSS vars apply.
const SK = 'rgba(255,255,255,0.10)';
const SK_CARD = 'rgba(255,255,255,0.06)';
const SK_BORDER = 'rgba(255,255,255,0.08)';

export default function RouteSkeleton({ cards = 3 }: { cards?: number }) {
  return (
